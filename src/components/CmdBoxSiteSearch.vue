<template>
    <fieldset class="cmd-box-sitesearch flex-container">
        ...
        <div class="flex-container">
            <CmdFormElement element="input" type="text" labelText="What do you like to search for?" placeholder="Search" />
            <CmdFormElement element="input" type="text" labelText="Where do you want to search?" placeholder="Zip, City" />
